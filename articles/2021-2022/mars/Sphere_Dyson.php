		...
		<div class="col-twelve">
			...
			<article class="format-standard">
				...
				<div class="primary-content">
					...
					<h1 class="page-title">La Sphère de Dyson</h1>

					<ul class="entry-meta">
						<li class="date">Mars 2022</li>
						<li class="cat"><a href="">Espace</a><a href="">Energie</a></li>
					</ul>
					
					<h1>Qu'est-ce que la sphère de Dyson?</h1>

					<p class="drop-cap">La sphère de Dyson est un projet théorique de <a class="lienimg smoothscroll" href="#def">Méga-Ingénierie</a>, proposée en 1960 par Freeman DYSON, physiciens théoricien et mathématicien britanno-américain. Inspiré par l’œuvre Star Maker de Olaf Stapledon,  Freeman a théorisé la « Sphère de Dyson », une coque artificielle autour d’une étoile, dans le but de capter un maximum d’énergie du soleil. Freeman Dyson, en extrapolant (voir lexique) les besoins énergétiques de l’humanité, s’est vite rendu compte que nous allons avoir besoin de toute l’énergie libéré par le soleil chaque années.</p>

					<p>Pour construire une telle cage, Dyson a calculé qu'en utilisant une masse de matière équivalente à celle de Jupiter, il est possible d'entourer notre Soleil d'une coque semi-solide, d'une épaisseur de 2 à 3 mètres, capable de piéger le rayonnement de notre étoile.</p>
					...
					<p id="hubble" class="lead"><img src="../../../images/articles/janvier/hubble.jpg">Hubble est un
					...
					<p id="spectre" class="lead"><img
							src="../../../images/articles/janvier/spectreelectromagnetique.png">L'infrarouge est un
					...
					<p id="lagrange" class="lead"><img src="../../../images/articles/janvier/lagrange.jpg">Le point
						Lagrange L2 est un point d'équilibre gravitationnel entre deux astres en l'occurrence la
						terre et le soleil.</p>

					<p id="ariane" class="lead"><img src="../../../images/articles/janvier/ariane5.jpg">Ariane 5 est
