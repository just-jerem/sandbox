				...
				<article class="format-standard">
					...
					<div class="content-media">
						<div class="post-thumb">
							<img src="../../../images/articles/jan-dec2023/IMG_20230124_223143.jpg">
						</div>
					</div>
					...
					<div class="primary-content">
						...
						<ul class="entry-meta">
							...
							<li class="cat"><a href="">Animaux</a></li>
						</ul>

						<p><img src="../../../images/articles/jan-dec2023/IMG_20230124_223205.jpg" alt=""></p>

						<h2>L'hydropote ou "Cerf Vampire"</h2>

						<p class="lead">Il est doté de deux longues canines supérieures et c'est le seul cervidé à ne pas porter de bois.</p>
					...
					<div class="pagenav group">
						...
						<div class="next-nav">
							<a href="Flocons_de_neige.php" rel="next">
								<span>Suivant</span>
								Les flocons de neige et leurs formes
							</a>
						</div>
					</div>
