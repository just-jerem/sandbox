         	...
         	<article class="brick entry format-standard animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">Just a Standard Format Post.</a></h1>
            ...
            <article class="brick entry format-standard animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">This Is Another Standard Format Post.</a></h1>
            ...
            <article class="brick entry format-audio animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-audio.php">This Is a Audio Format Post.</a></h1>
         	...
         	<article class="brick entry format-standard animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">Photography Skills Can Improve Your Graphic Design.</a></h1>
            ...
            <article class="brick entry format-standard animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">The 10 Golden Rules of Clean Simple Design.</a></h1>
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-gallery.php">Workspace Design Trends and Ideas.</a></h1>
         	...
         	<article class="brick entry animate-this">
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">You Can See Patterns Everywhere.</a></h1>
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-video.php">This Is a Video Post Format.</a></h1>
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">Breathtaking Photos of Lighthouses.</a></h1>
               ...
               <div class="entry-text">
               	<div class="entry-header">
               		...
               		<h1 class="entry-title"><a href="single-standard.php">Designing With Black and White.</a></h1>
